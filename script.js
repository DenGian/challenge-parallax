...
function animate() {
    ...
    // ctx.drawImage(backgroundLayer1, x, 0) // take an image and draw it on the canvas
    // ctx.drawImage(backgroundLayer1, x2, 0) // take the second image and draw it on the canvas
    // if (x < -2400) x = 2400 + x2 - gameSpeed; // resetting image for when it goes offscreen (2400 = width of picture) - checking x2 position
    // else x -= gameSpeed; // make image move to the left - at the speed the gameSpeed variable is set to
